...
BENCHMARK_TASKS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "type": "classification",
        "prompt": (
            'Classifique como POSITIVO, NEGATIVO ou NEUTRO: "O Fed manteve os juros estáveis e sinalizou cautela."'
        ),
    ...
    },
    {
        ...
        "type": "summarization",
        "prompt": (
            "Resuma em uma frase: 'O índice de inflação IPCA registrou alta de 0,38% em julho, "
            "abaixo das expectativas do mercado de 0,45%, puxado pela queda nos preços de "
            "alimentos e energia.'"
        ),
