...
MARKET_THRESHOLDS: dict[str, dict] = {
    ...
    "dowjones": {"symbol": "^DJI", "label": "Dow Jones", "unit": "percent", "high": 1.2, "medium": 0.5, "group": "indices"},
    "ftse100": {"symbol": "^FTSE", "label": "FTSE 100", "unit": "percent", "high": 1.2, "medium": 0.5, "group": "indices"},
    ...
    "usdcny": {"symbol": "CNY=X", "label": "Renminbi", "unit": "percent", "high": 0.5, "medium": 0.2, "group": "cambio"},
    "us3m": {"symbol": "^IRX", "label": "US Treasury 3M", "unit": "percentage_points", "high": 0.08, "medium": 0.04, "group": "juros"},
    "us5y": {"symbol": "^FVX", "label": "US Treasury 5Y", "unit": "percentage_points", "high": 0.10, "medium": 0.05, "group": "juros"},
    "us10y": {"symbol": "^TNX", "label": "US Treasury 10Y", "unit": "percentage_points", "high": 0.10, "medium": 0.05, "group": "juros"},
    "us30y": {"symbol": "^TYX", "label": "US Treasury 30Y", "unit": "percentage_points", "high": 0.10, "medium": 0.05, "group": "juros"},
    ...
    "silver": {"symbol": "SI=F", "label": "Prata", "unit": "percent", "high": 2.0, "medium": 1.0, "group": "commodities"},
